...
for task in suites.build_suite(BENCHMARKS_DIR, SUITE):
    ...
    run.set_property("algorithm", "exact-undirected")
    ...
    # multiple algorithms.
    run.set_property("id", ["exact-undirected", task.domain, task.problem])
    ...
    run.set_property("domain", task.domain)
    run.set_property("problem", task.problem)
    run.set_property("algorithm", "exact-directed")
    # BaseReport needs the following properties:
    # 'time_limit', 'memory_limit'.
    run.set_property("time_limit", TIME_LIMIT)
    run.set_property("memory_limit", MEMORY_LIMIT)
    ...
    # The algorithm name is only really needed when there are
    # multiple algorithms.
    run.set_property("id", ["exact-directed", task.domain, task.problem])
